...
from biosteam.units.design_tools.vacuum import compute_vacuum_system_power_and_cost
from biosteam import Unit
from biosteam.units.splitting import FakeSplitter
...
class BinaryDistillation(Distillation, new_graphics=False):
    ...
    def reset_cache(self, isdynamic=None):
        if not hasattr(self, '_McCabeThiele_args'):
            ...
            self._McCabeThiele_args = np.zeros(6)
            print('reset McCabeThiele')
            for i in self.auxiliary_units[0:2]: i.reset_cache()
